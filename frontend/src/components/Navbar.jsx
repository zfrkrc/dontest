                    ...
                    <div className="collapse navbar-collapse opacityScrollOff" id="navbarSupportedContent">
                        <ul className="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                            <li className="nav-item">
                                <a className="nav-link link text-black show text-primary display-4" href="/#testimonials-8-uSrJKo6yl4" aria-expanded="false">Hakkımızda</a>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <a className="nav-link link text-black text-primary display-4" href="/#contacts-2-uSrJKocEPl">İletişim</a>
                            </li>
                        </ul>
                        <div className="icons-menu">
                            ...
                            <a className="iconfont-wrapper" href="/#contacts-2-uSrJKocEPl">
